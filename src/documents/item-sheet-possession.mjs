 ...
 */
export class CastleFalkensteinPossessionSheet extends api.HandlebarsApplicationMixin(sheets.ItemSheetV2) {
  ...
  static PARTS = {
    sheet: { template: "systems/castle-falkenstein/src/documents/item-sheet-possession.hbs" }
  };
