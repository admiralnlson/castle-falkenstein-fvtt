...
### Changed
- In the weapons compendium, animal sizes now match the ones documented in sourcebook "Curious Creatures" (Large becomes Medium ; Very Large becomes Large). A mapping to Dragon attacks in animal attack descriptions was also added for convenience.
