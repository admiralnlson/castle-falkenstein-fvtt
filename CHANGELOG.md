...
- The names of an unlinked token and of its synthetic actor are now kept in sync.
### Fixed
- The sheet of unlinked token now displays the token's name rather than the unlinked actor's name.
